...
-- 2. Alternatively, if you are SURE you want to DELETE them and they have NEVER been used in production/finishing:
-- DELETE FROM part_numbers WHERE created_at < NOW();
--
-- Warning: If you delete parts that are referenced in production_entries or finishing_entries,
